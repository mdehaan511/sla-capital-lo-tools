 ...
 *   4. Optional quote-store sync (loanForQuoteSync) — Phase D kills
 *      the quote/loan duality; until then, same rules as before.
 *
 ...
 *   loanForQuoteSync — loan record to mirror into the quotes store.
