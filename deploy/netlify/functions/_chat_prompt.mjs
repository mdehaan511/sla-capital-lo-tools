...
- RTL: 650-679 → 12%. 620-649 → 13%. 550-619 → 14% + ~40% down. Below 550 → tell them to fix credit and come back.
- Below 650 on RTL, the combination of high down payment and high rate kills most deals on the borrower's side anyway.
