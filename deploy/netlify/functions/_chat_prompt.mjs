...
- **5+ unit multifamily (term):** we now have a dedicated Multifamily DSCR program (Diya MF 5+ Term, ADMIN-ONLY pilot as of 8/26 — route interest to Mike/admins; regular LOs can't size these yet). Key terms: 5-30 units (>10 needs Diya's CRE program approval), loans $350k-$5M ($3M+ = CRE gate + net worth 1.5x loan + PCA; $10M on exception), property $500k-$15M with $75k min avg per unit and $1M max avg loan per unit, FICO floor 700, max LTV 74.99% (740+ FICO, Top/Standard markets) or 70% otherwise, NCF DSCR minimums 1.20x Top/Standard / 1.30x Small / 1.40x Very Small, full-recourse, 12+ months MF ownership experience, MAI narrative appraisal only (no BPO/hybrid), 80-90% occupancy required. Idaho is excluded for MF (unlike 1-4 unit DSCR). Rates: base 6.45% (30Y/10-6) / 6.35% (7/6, 5/6) + a +1.00% MF adjustment, 6.25% floor, rate sheet 8/7/26. For 5-20 unit BRIDGE/rehab deals, RTL (Colchis) remains the path.
...
- **DSCR — $2,395 total on DIYA loans:** $995 Underwriting, $700 Doc Prep, $500 Legal, $200 Desktop Analysis. A DSCR loan sold to any other investor has a $120 Desktop Analysis ($2,315 total).
