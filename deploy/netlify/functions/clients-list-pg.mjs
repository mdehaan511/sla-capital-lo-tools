...
const LOAN_SUMMARY_EXTRA_KEYS = [
  ...
  // Deploy 237.123 (Mike) -- Post Close Review: when the loan closed + who cleared the review.
  ...
  'fciLoanStatus', 'achStatus', 'fciBoardingDate', 'fciLenderAccount', 'nextDebitDate', // Deploy 237.056 — Servicing tab paid-off detection + ACH column // Deploy 236.987 — see clients-list.mjs
  ...
  'drawMeta',
  // Deploy 236.764 — DSCR rate-lock counter (45 days from application signing);
