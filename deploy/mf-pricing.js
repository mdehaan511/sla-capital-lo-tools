...
const DIYA = {
  ...
  // Deploy 236.994 — 9.12.26 sheet ("rate-sheet-2026-09-12 (1).xlsx"): base
  //   rates +0.075 across the board (6.75 -> 6.825 / 6.65 -> 6.725); min rate,
  //   PPP (321 still +0.300), FICO/LTV, IO, 5+ Multi, DSCR, UPB all unchanged.
  // Deploy 236.973 — 9.11.26 sheet ("rate-sheet-2026-09-11 (1).xlsx"): base
  //   rates +0.075 across the board (6.675 -> 6.75 / 6.575 -> 6.65); min rate,
  //   PPP (321 still +0.300), FICO/LTV, IO, 5+ Multi, DSCR, UPB all unchanged.
  // Deploy 236.942 — 9.10.26 sheet ("rate-sheet-2026-09-10 (1).xlsx"): base
  // rates +0.050 on all four products. Everything else diffed cell-by-cell and
  ...
  //   PPP (321 still +0.300), FICO/LTV, IO, 5+ Multi, DSCR, UPB all unchanged.
  // Deploy 237.089 — 9.16.26 sheet ("rate-sheet-2026-09-16 (1).xlsx"): base rates
  //   +0.100 across the board (6.875 -> 6.975 / 6.775 -> 6.875); min rate 6.25,
  //   PPP, FICO/LTV, IO, 5+ Multi, DSCR, UPB all unchanged (6 differing cells =
  //   the two dates + the four base rates).
  // Deploy 237.145 — 9.18.26 sheet ("rate-sheet-2026-09-18 (1).xlsx"): base
  //   rates -0.050 across the board (6.975 -> 6.925 / 6.875 -> 6.825); min rate 6.25,
  //   PPP (3-Year still +0.300, 5-Year -0.100, 5Yr/6Mo -0.150), FICO/LTV, IO, 5+ Multi,
  //   DSCR, UPB all unchanged (6 differing cells = the two dates + the four base rates).
  // Deploy 237.261 — 9.24.26 sheet ("rate-sheet-2026-09-24 (1).xlsx"): base rates
  //   30Y Fixed & 10/6 ARM 6.925 -> 7.075 (+0.150), 7/6 ARM 6.825 -> 6.975 (+0.150),
  //   5/6 ARM 6.825 -> 7.125 (+0.300 — the first sheet to price the 5/6 above the 7/6;
  //   applied exactly as printed and flagged to Mike in case it is a typo); min rate
  //   6.25, PPP, FICO/LTV, IO, 5+ Multi, DSCR, UPB all unchanged (6 differing cells =
  //   the two dates + the four base rates).
  effectiveDate: "September 24, 2026",
  minRate: 6.25,
  baseRate: { "30Y Fixed": 7.075, "10/6 ARM": 7.075, "7/6 ARM": 6.975, "5/6 ARM": 7.125 }, // 237.261: +0.150, 5/6 ARM +0.300 (9.24.26 sheet)
...
const FEES = {
  ...
  doc_prep: 700,
  legal_doc: 500,
  desktop_analysis: 200,        // Deploy 237.016 (Mike): was 120 — same schedule as 1-4 unit DSCR — DIYA loans ONLY
